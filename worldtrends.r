...
# After you import the csv file into R the first step is to split
# the data frame into two:
# data1960 and data2013
# In order to achieve this use data frame filtering we
